-- ========================================
-- Naveeg Supabase Schema Migration
...
-- Make subdomain unique in sites
CREATE UNIQUE INDEX IF NOT EXISTS uniq_sites_subdomain ON public.sites(subdomain);
...
-- 5) PROMOTE DRAFT TO SITE FUNCTION
...
-- 6) SECURITY - Revoke direct insert on sites
