...
export function HeroMock() {
  // Use deterministic animation to avoid hydration issues
  ...
  return (
    ...
    >
      {/* Background card */}
      <div className="absolute inset-0 bg-gradient-to-br from-gray-100/60 to-gray-200/60 rounded-[1.2rem] transform rotate-3 scale-95 opacity-40"></div>
      
      {/* Middle card */}
      <div className="absolute inset-0 bg-white/60 backdrop-blur-sm rounded-[1.2rem] transform -rotate-2 scale-98 shadow-lg border border-white/20"></div>
      ...
      <div className="relative bg-white/80 backdrop-blur-md rounded-[1.2rem] shadow-xl border border-white/40 p-6">
        ...
        <div className="flex items-center space-x-2 mb-4">
          ...
          <div className="flex-1 bg-gray-100/80 rounded-lg h-6 ml-2"></div>
        </div>
        ...
        <div className="space-y-3">
          ...
          <div className="h-4 bg-gray-200/80 rounded w-2/3"></div>
        </div>
